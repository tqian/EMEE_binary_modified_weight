...
pdEMEE_efficiency_Delta = data.frame()
pdEMEE2_efficiency_Delta = data.frame()
...
for (Delta in 1:10) {
  ...
  pdEMEE_efficiency_Delta = rbind(pdEMEE_efficiency_Delta, c(Delta, relative_efficiency_EMEE))
  pdEMEE2_efficiency_Delta = rbind(pdEMEE2_efficiency_Delta, c(Delta, relative_efficiency_EMEE2))
  result_df_collected$delta = Delta
  result_table = rbind(result_table, result_df_collected)
}

saveRDS(pdEMEE_efficiency_Delta, file = "pdEMEE_efficiency_Delta.RDS")
saveRDS(pdEMEE2_efficiency_Delta, file = "pdEMEE2_efficiency_Delta.RDS")
